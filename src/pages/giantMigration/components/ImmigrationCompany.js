        ...
        <div className="container" data-aos="fade-up" data-aos-duration="2000" data-aos-easing="linear">
            <div className="row">
                <div className="col-md-12">
                    <h2>Giant <span className='highlight'>Migration</span></h2>
                    <h4>How did the immigration company gain <br/>website traffic by a whopping <span className="highlight">190%</span> in just 1 year?</h4>
                    <p>Most people dream of settling abroad and to accomplish this dream, immigration firms help. But what <br/>happens to a newbie, a new company in an already competitive market?</p>
                </div>
            </div>
            ...
            <p className="text-left">Giant Migration, even though an extraordinarily resourceful company, lacked the opportunity of visibility. As a comparatively new immigration company, Giant Migration needed digital marketing to maximise their digital visibility so that they could reach to potential clients.</p>
            <p className="text-left">We had a number of goals in front of us to bring Giant Migration into the main game. Right from an effective SEO strategy to SMO mantras, we knew we had to put in everything to pull Giant Migration in the rankings where it now stands.</p>
            </div>
            </div>
        </div>
    </section>
