...
export default function WebsiteProcess(props) {
    return (
        ...
        <div className="container">
            ...
            <h3 data-aos="fade-right" data-aos-duration="1000" data-aos-easing="linear">Frequently Asked Questions about <span className='highlight'>Social Media Marketing</span></h3>
            <div className="row mt-3">
               
                {
                    props.Process.map((value,index)=>{
                        return(
                            <Fragment key={index}>
                                <div className="col-md-6 d-flex" data-aos="fade-left" data-aos-duration="1000" data-aos-easing="linear">
